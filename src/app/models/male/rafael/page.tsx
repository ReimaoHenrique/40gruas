          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-6">
                Especialista em campanhas publicitárias.
              </p>
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <span className="w-3 h-3 bg-blue-500 rounded-full mr-3"></span>
                  <span className="text-gray-700">Publicidade</span>
                </div>
                <div className="flex items-center">
                  <span className="w-3 h-3 bg-blue-500 rounded-full mr-3"></span>
            ...
            <div className="bg-gradient-to-br from-blue-200 to-blue-300 rounded-lg aspect-square flex items-center justify-center">
              <span className="text-blue-600 text-lg">Foto do Rafael</span>
            </div>
          </div>
        </div>
      </section>
