          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-6">
                Modelo feminina para desfiles e apresentações.
              </p>
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <span className="w-3 h-3 bg-pink-500 rounded-full mr-3"></span>
                  <span className="text-gray-700">Desfiles</span>
                </div>
                <div className="flex items-center">
                  <span className="w-3 h-3 bg-pink-500 rounded-full mr-3"></span>
                  <span className="text-gray-700">Apresentações</span>
                </div>
                <div className="flex items-center">
                  <span className="w-3 h-3 bg-pink-500 rounded-full mr-3"></span>
            ...
            <div className="bg-gradient-to-br from-pink-200 to-pink-300 rounded-lg aspect-square flex items-center justify-center">
              <span className="text-pink-600 text-lg">Foto da Júlia</span>
            </div>
          </div>
        </div>
      </section>
