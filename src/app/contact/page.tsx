...
export const metadata: Metadata = {
  ...
  description: "Entre em contato com a Lux Models para solicitar um orçamento. Respondemos em até 15 minutos. Agência de modelos profissionais para fotografia, desfiles e eventos.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Entre em contato com a Lux Models para solicitar um orçamento. Respondemos em até 15 minutos.",
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="pt-24 pb-16 bg-gradient-to-br from-gray-50 to-white" aria-label="Página de Contato">
              ...
              <div>
                ...
                <address className="space-y-8 not-italic">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+11999999999" className="hover:text-primary transition-colors">(11) 99999-9999</a><br />
                      <a href="tel:+11888888888" className="hover:text-primary transition-colors">(11) 88888-8888</a>
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:contato@luxmodels.com.br" className="hover:text-primary transition-colors">contato@luxmodels.com.br</a><br />
                      <a href="mailto:comercial@luxmodels.com.br" className="hover:text-primary transition-colors">comercial@luxmodels.com.br</a>
                    </p>
                  </div>
